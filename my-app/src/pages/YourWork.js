...
function YourWork() {
  ...
  return (
    <div className="w-4/5 mx-auto py-10">
      <h1 className="text-4xl text-center text-gray-800 mb-6">Your Saved Resumes</h1>
      {resumes.length > 0 ? (
        ...
        <div className="text-center">
          ...
          <a href="/create" className="bg-blue-500 text-white px-6 py-3 rounded">Create a Resume Now</a>
        </div>
      )}
    </div>
  )
